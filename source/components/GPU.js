...
class GPU {
    ...
    readByte(address) {
        ...
        switch (address) {
            ...
            case 0xFF41: 
                ...
                return stat; 
            case 0xFF42: return this.register.scy;
            case 0xFF43: return this.register.scx;
            case 0xFF44: 
                ...
                return ly;
            case 0xFF45: return this.register.lyc;
            case 0xFF46: return this.register.dma;
            case 0xFF47: return this.register.bgp;
            case 0xFF48: return this.register.obj0;
    ...
    writeByte(address, byte) {
        ...
        // GPU Registers
        switch (address) {            
            case 0xFF40: this.register.lcdc = byte; return;
            case 0xFF41: this.register.stat = byte; return;
            case 0xFF42: this.register.scy = byte; return;
...
//         let sx = this.register.scx; 
//         let sy = this.register.scy;
//         let wx = this.register.wx - 7;
//         let wy = this.register.wy;
//         let ly = this.register.ly;

//         // Check if window is enabled.
//         let windowEnabled = !!(this.register.lcdc&0x20) && wy <= ly;
//         let tilemapRegion = 0;
...
//         // Check if window is enabled.
//         let windowEnabled = !!(this.register.lcdc&0x20);
//         let tilemapRegion = 0;
